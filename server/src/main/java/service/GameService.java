...
//    private Integer nextGameNumber = 1001;
    ...
    public CreateGameResult createGame(CreateGameRequestS makeGameRequest) throws ServiceException, DataAccessException {
    ...
    public void joinGame(JoinGameRequestS joinGameRequest) throws ServiceException, DataAccessException {
